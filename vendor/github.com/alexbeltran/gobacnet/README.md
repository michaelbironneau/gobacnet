# goBACnet 
[![Build Status](https://travis-ci.com/michaelbironneau/gobacnet.svg?token=pGXqDCNsbwsP7nyfos9q&branch=master)](https://travis-ci.com/michaelbironneau/gobacnet)
[![GoDoc](https://godoc.org/github.com/michaelbironneau/gobacnet?status.svg)](https://godoc.org/github.com/michaelbironneau/gobacnet)
...
```
go get -u github.com/michaelbironneau/gobacnet/baccli
```
